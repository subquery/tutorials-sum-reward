...
type NoBondRecordAccountProps = Omit<NoBondRecordAccount, NonNullable<FunctionPropertyNames<NoBondRecordAccount>>>;
...
export class NoBondRecordAccount implements Entity {
    ...
    static async get(id:string): Promise<NoBondRecordAccount | undefined>{
        ...
        if (record){
            return NoBondRecordAccount.create(record as NoBondRecordAccountProps);
        }else{
            return;
        }
    }
    ...
    static create(record: NoBondRecordAccountProps): NoBondRecordAccount {
